...
-- SQLINES DEMO *** -08-23 22:32:51 COT
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE TABLE persons_evaluations
    (
     id_person_evaluation BIGSERIAL NOT NULL ,
     result_evaluation TEXT ,
     datereg_person_evaluation TIMESTAMP(3) ,
     qualification_person_evaluation NUMERIC (28) ,
     trynumber_person_evaluation INTEGER ,
     timespent_person_evaluation NUMERIC (28) ,
     persons_id_person BIGINT NOT NULL ,
     evaluations_id_evaluation BIGINT NOT NULL
    );

ALTER TABLE persons_evaluations ADD CONSTRAINT persons_evaluations_PK PRIMARY KEY (id_person_evaluation, evaluations_id_evaluation)
     ;
...
CREATE TABLE question_category
    (
     ...
     name_questioncategory VARCHAR (30) NOT NULL ,
     state_questioncategory CHAR (1) NOT NULL
    );
...
ALTER TABLE persons_evaluations
    ADD CONSTRAINT persons_evaluations_evaluations_FK FOREIGN KEY
    (
     evaluations_id_evaluation
    )
    REFERENCES evaluations
...
ALTER TABLE persons_evaluations
    ADD CONSTRAINT persons_evaluations_persons_FK FOREIGN KEY
    (
     persons_id_person
    )
    REFERENCES persons
